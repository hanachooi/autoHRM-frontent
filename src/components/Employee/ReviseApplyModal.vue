    ...
    <div class="modal-content">
      ...
      <form @submit.prevent="submitRectify">
        <div class="form-group">
          <label for="rectifyDate">정정 날짜:</label>
...
const submitRectify = async () => {
  try {
    ...
    await axios.post("http://211.253.28.110:8080/api/v1/apply/commute", requestData, {
      headers: {
    ...
    alert("정정 신청이 성공적으로 제출되었습니다.");
    closeModal();
  } catch (error) {
    alert("정정 신청에 실패하였습니다. 다시 시도해주세요.");
  }
};
</script>
